def global_init():
    ...
    global setup_screen_fontsize, setup_screen_font_color, setup_screen_bg_color, sc_x, sc_y, mc_x, mc_y, gamemode_solvethemaze, gamemode_timelimited, gamemode_speedrun, gamemode_text, kbm_click_and_drag
    path = (255, 255, 255)
